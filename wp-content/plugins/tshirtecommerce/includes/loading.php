...
function design_loading_setting($values)
{
	...
	{
		echo '<input type="text" size="60" value="'.$values['text_loading'].'" name="designer[text_loading]">';
	}
	else
	{
		echo '<input type="text" size="60" value="T-Shirt eCommerce Designer is Loading..." name="designer[text_loading]">';
	}	
	echo '</td></tr>';

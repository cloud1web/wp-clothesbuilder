<?php 
add_action( 'admin_enqueue_scripts', 'ecomHelpPointers' );

function ecomHelpPointers() // rename for not namesake with some theme.
{
    $pointers = array(       
		array(
		...
		array(
            'id'       => 'e_tshirt_load_blank',
            'screen'   => 'product',
            'target'   => '#e_tshirt_load_blank',
            'title'    => 'Add Product Design',
            'content'  => 'Click change product design to create or choose a product design for connect.',
            'position' => array(
                'edge'  => 'top',
                'align' => 'left'
            )
		...
		array(
            'id'       => 'e_tshirt_load_design_temp',
            'screen'   => 'product',
            'target'   => '#e_tshirt_load_design_temp',
            'title'    => 'Add Design Template',
            'content'  => 'Click design template to create or choose a design template for connect.',
            'position' => array(
                'edge'  => 'top',
                'align' => 'left'
            )
		...
		array(
            'id'       => 'e_tshirt_remove_design',
            'screen'   => 'product',
            'target'   => '#e_tshirt_remove_design',
            'title'    => 'Remove Product Design',
            'content'  => 'Click clear to remove product design connected.',
            'position' => array(
                'edge'  => 'top',
                'align' => 'left'
            )

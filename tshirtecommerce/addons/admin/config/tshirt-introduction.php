...
?>
<hr />
<h4>Site Introduction</h4>
<p class="help-block">Setting display site introduction </small></p>
...
<div class="form-group row">
	<label class="col-sm-3 control-label">Time Automatic</label>
	<div class="col-sm-4">
		<input type="text" class="form-control input-sm" value="<?php echo $data['settings']['introAutoTimeVal']; ?>" name="setting[introAutoTimeVal]">		
		<span class="help-block"><small>Time automatic transfer next step</small></span>	
	</div>	
